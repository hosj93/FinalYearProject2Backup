...
namespace Bank_Card_Perso
{
    ...
    public partial class XButton : Button
    {
        ...
        private Bank_Card_Perso.Theme thm = Bank_Card_Perso.Theme.MSOffice2010_BLUE;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (thm == Bank_Card_Perso.Theme.MSOffice2010_BLUE || thm == Bank_Card_Perso.Theme.MSOffice2010_Green || thm == Bank_Card_Perso.Theme.MSOffice2010_Yellow || thm == Bank_Card_Perso.Theme.MSOffice2010_Publisher ||

                thm == Bank_Card_Perso.Theme.MSOffice2010_RED || thm == Bank_Card_Perso.Theme.MSOffice2010_WHITE || thm == Bank_Card_Perso.Theme.MSOffice2010_Pink)
            {
        ...
        public Bank_Card_Perso.Theme Theme
        {
            ...
            get
            {
                ...
                if (this.colorTable == Colortable.Office2010Green)
                {
                    ...
                    return Bank_Card_Perso.Theme.MSOffice2010_Green;
                ...
                else if (this.colorTable == Colortable.Office2010Red)
                {
                    ...
                    return Bank_Card_Perso.Theme.MSOffice2010_RED;
                ...
                else if (this.colorTable == Colortable.Office2010Pink)
                {
                    ...
                    return Bank_Card_Perso.Theme.MSOffice2010_Pink;
                ...
                else if (this.colorTable == Colortable.Office2010Yellow)
                {
                    ...
                    return Bank_Card_Perso.Theme.MSOffice2010_Yellow;
                ...
                else if (this.colorTable == Colortable.Office2010White)
                {
                    ...
                    return Bank_Card_Perso.Theme.MSOffice2010_WHITE;
                ...
                else if (this.colorTable == Colortable.Office2010Publisher)
                {
                    ...
                    return Bank_Card_Perso.Theme.MSOffice2010_Publisher;

                }



                return Bank_Card_Perso.Theme.MSOffice2010_BLUE;
            ...
            set
            {
                ...
                if (thm == Bank_Card_Perso.Theme.MSOffice2010_Green)
                {
                ...
                else if (thm == Bank_Card_Perso.Theme.MSOffice2010_RED)
                {
                ...
                else if (thm == Bank_Card_Perso.Theme.MSOffice2010_Pink)
                {
                ...
                else if (thm == Bank_Card_Perso.Theme.MSOffice2010_WHITE)
                {
                ...
                else if (thm == Bank_Card_Perso.Theme.MSOffice2010_Yellow)
                {
                ...
                else if (thm == Bank_Card_Perso.Theme.MSOffice2010_Publisher)
                {
