...
{
    public partial class ExpressMode : Form
    {
        ...
        private void btnNextOne_Click(object sender, EventArgs e)
        {
            ...
            {
                epFraming.SetImagePreview(oriBrightnessImage.Clone() as Image);
            }
            else if(trcBrightness.Value ==0 && trcContrast.Value !=0)
            {
                epFraming.SetImagePreview(finalImage.Clone() as Image);
        ...
        public void trcBrightness_Scroll(object sender, EventArgs e)
        {
            ...
            picBoxOne.Image = oriBrightnessImage;
            picBoxOne.SizeMode = PictureBoxSizeMode.StretchImage;

        }

        public void trcContrast_Scroll(object sender, EventArgs e)
        {
            ...
            picBoxOne.Image = (Bitmap)cloneConstrastImage.Clone();
            finalImage = picBoxOne.Image;
        }

        private void btnResetImage_Click(object sender, EventArgs e)
        {
            picBoxOne.Image = origImage;
